...
class VideoService {
	...
	static private $services = array(
		'archiveorg' => array(
			...
			'default_width' => 640,
			'default_ratio' => 1.2994923857867999,
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#archive\\.org/(?:details|embed)/([\\d\\w\\-_][^/\\?\\#]+)#is'
			),
			'id_regex' => array(
				0 => '#^([\\d\\w\\-_][^/\\?\\#]+)$#is'
			)
		...
		'bambuser' => array(
			...
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#bambuser\\.com/(?:v|broadcast)/([\\d\\w\\-\\+]+)(?:/\\S+?)?#is'
			),
			'id_regex' => array(
				0 => '#^([\\d\\w\\-\\+]+)$#is'
			)
		...
		'bambuser_channel' => array(
			...
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#bambuser\\.com/channel/([\\d\\w\\-\\+]+)(?:/\\S+?)?#is'
			),
			'id_regex' => array(
				0 => '#^([\\d\\w\\-\\+]+)$#is'
			)
		...
		'bing' => array(
			...
			'default_width' => 640,
			'default_ratio' => 1.7777777777777799,
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#bing.com/videos/watch/video/[\\w\\d\\-]+?/([a-zA-Z0-9]+)(?:/\\S+?)?#is'
			),
			'id_regex' => array(
				0 => '#^([a-zA-Z0-9]+)$#is'
			)
		...
		'collegehumor' => array(
			...
			'default_width' => 640,
			'default_ratio' => 1.6260162601626,
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#collegehumor\\.com/(?:video|e)/([\\d]+)#is'
			),
			'id_regex' => array(
				0 => '#^([\\d]+)$#is'
			)
		...
		'dailymotion' => array(
			...
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#dailymotion\\.com/(?:video|embed/video)/([a-zA-Z0-9]+)(?:_\\S+?)?#is'
			),
			'id_regex' => array(
				0 => '#^([a-zA-Z0-9]+)(?:_\\S+?)#is'
			)
		...
		'funnyordie' => array(
			...
			'default_width' => 640,
			'default_ratio' => 1.6410256410256401,
			'https_enabled' => false,
			'url_regex' => array(
				0 => '#funnyordie\\.com/(?:videos|embed)/([a-zA-Z0-9]+)(?:/\\S+?)?#is'
			),
			'id_regex' => array(
				0 => '#^([a-zA-Z0-9]+)$#is'
			)
		...
		'kickstarter' => array(
			...
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#kickstarter\\.com/projects/([\\d\\w-]+/[\\d\\w-]+)(?:/widget/video.html)?#is'
			),
			'id_regex' => array(
				0 => '#^([\\d\\w-]+/[\\d\\w-]+)$#is'
			)
		...
		'metacafe' => array(
			...
			'https_enabled' => false,
			'url_regex' => array(
				0 => '#metacafe\\.com/(?:watch|embed)/([\\d]+)(?:/\\S+?)?#is'
			),
			'id_regex' => array(
				0 => '#^([\\d]+)$#is'
			)
		...
		'nico' => array(
			...
			'default_width' => 640,
			'default_ratio' => 1.59609120521173,
			'https_enabled' => false,
			'url_regex' => array(
				0 => '#nicovideo\\.jp/watch/((?:[a-zA-Z]{2})?[\\d]+)#is'
			),
			'id_regex' => array(
				0 => '#^((?:[a-zA-Z]{2})?[\\d]+)$#is'
			)
		...
		'rutube' => array(
			...
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#rutube\\.ru/video/([a-zA-Z0-9]+)(?:/\\S+?)?#is'
			),
			'id_regex' => array(
				0 => '#^([a-zA-Z0-9]+)$#is'
			)
		...
		'teachertube' => array(
			...
			'default_width' => 640,
			'default_ratio' => 1.72972972972973,
			'https_enabled' => false,
			'url_regex' => array(
				0 => '#teachertube\\.com/video/(?:[\\w\\d\\-]+?-)?([\\d]+)$#is'
			),
			'id_regex' => array(
				0 => '#^([\\d]+)$#is'
			)
		...
		'tudou' => array(
			...
			'default_width' => 640,
			'default_ratio' => 1.6000000000000001,
			'https_enabled' => false,
			'url_regex' => array(
				0 => '#tudou.com/listplay/([\\d\\w-]+)/([\\d\\w-]+).html#is',
				1 => '#tudou.com/listplay/([\\d\\w-]+).html#is'
			),
			'id_regex' => array(
				0 => '#^([\\d\\w-]+)$#is'
			)
		...
		'twitch' => array(
			...
			'default_width' => 640,
			'default_ratio' => 1.64021164021164,
			'https_enabled' => false,
			'url_regex' => array(
				0 => '#twitch\\.tv/([\\d\\w-]+)(?:/\\S+?)?#is'
			),
			'id_regex' => array(
				0 => '#^([\\d\\w-]+)$#is'
			)
		...
		'yahoo' => array(
			...
			'https_enabled' => true,
			'url_regex' => array(
				0 => '#screen\\.yahoo\\.com/([\\w\\d\\-]+?-\\d+).html#is'
			),
			'id_regex' => array(
				0 => '#^([\\w\\d\\-]+?-\\d+)$#is'
			)
